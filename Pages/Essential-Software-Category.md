...
![Vozer-1](../Images/vozer-1.jpg)

- [📜 **Danh mục phần mềm thiết yếu** 📜](#-danh-mục-phần-mềm-thiết-yếu-)
  - [🌍 1. Trình duyệt Web](#-1-trình-duyệt-web)
  - [📄 2. Phần mềm soạn thảo văn bản](#-2-phần-mềm-soạn-thảo-văn-bản)
  - [🗃 3. Phần mềm nén/giải nén file/folder](#-3-phần-mềm-néngiải-nén-filefolder)
  - [📝 4. Phần mềm xem/chỉnh sửa PDF](#-4-phần-mềm-xemchỉnh-sửa-pdf)
  - [🌐 5. Phần mềm download](#-5-phần-mềm-download)
  - [📦 6. Phần mềm App Uninstaller](#-6-phần-mềm-app-uninstaller)
  - [⌨ 7. Phần mềm gõ tiếng Việt](#-7-phần-mềm-gõ-tiếng-việt)
  - [💻 8. Phần mềm điều khiển thiết bị từ xa](#-8-phần-mềm-điều-khiển-thiết-bị-từ-xa)
  - [📁 9. Phần mềm quản lý/tìm kiếm file/folder](#-9-phần-mềm-quản-lýtìm-kiếm-filefolder)
...
| [UniGet](https://www.marticliment.com/unigetui/) | Quản lý các CLI (Command-line interface) package, kể cả phần mềm cài trong máy, rất mạnh | ✔ | ❌ |
...
## 📁 9. Phần mềm quản lý/tìm kiếm file/folder

😍 ***Phổ biến nhất:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [Files](https://files.community/) | UI/UX đẹp nhưng nặng, tốc độ không cao | ✔ |❌ |
| [Explorer++](https://explorerplusplus.com/) | Khá nhiều feature, nhanh nhẹ mượt ngốn ít RAM | ✔ |❌ |
| [Everything](https://www.voidtools.com/downloads/) | Khả năng tìm kiếm nhanh, gọn nhẹ | ✔ |❌ |

🤩 ***Lựa chọn thay thế:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [360FileExplorer](https://mega.nz/file/WhRB3aYa#xIWEvtf43OiXaX7wbdcJ73G3Mrv0nb_XbDG5kg8fYl0) | Hàng China, y như Windows Explorer nhưng có tab, không nhiều tính năng | ❌ | ❌ |
| [One Commander](https://www.onecommander.com/) | Nhiều tính năng, UI/UX đẹp mắt, hơi ngốn RAM | ❌ | ❌ |
| [Total Commander](https://www.ghisler.com/) | App lâu đời, UI/UX hơi cổ, nhiều tính năng | ❌ | ❌ |
| [Directory Opus](https://www.gpsoft.com.au/) | Tính năng không nhiều bằng One Commander nhưng nhẹ, nhanh hơn | ❌ | ✔ |
| [Tablacus Explorer](https://tablacus.github.io/explorer_en.html) | Nhiều tính năng, add-on, kết hợp được với Everything | ✔ |❌ |
| [QuickLook](https://github.com/QL-Win/QuickLook) | Đem tính năng Quick Look từ macOS vào Windows | ✔ |❌ |

## 📬 10. Phần mềm quản lý email

😍 ***Phổ biến nhất:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [ThunderBird](https://www.thunderbird.net/en-US/) | Hàng lâu đời, nhanh, mạnh | ✔ |❌ |
| [K-9 Mail](https://k9mail.app/) | Thunderbird phiên bản Android | ✔ |❌ |

🤩 ***Lựa chọn thay thế:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [GetMailSpring](https://www.getmailspring.com/) | UI/UX đẹp, tính năng y như ThunderBird | ✔ |❌ |
| [eM Client](https://www.emclient.com/) | UI/UX đẹp, nhiều tính năng | ❌ | ❌ |
| [Spark Mail](https://sparkmailapp.com/) | UI/UX đẹp, nhiều tính năng | ❌ | ❌ |
| [Canary Mail](https://canarymail.com/) | UI/UX đẹp, nhiều tính năng | ❌ | ❌ |

## 🏢 10. Phần mềm cho văn phòng

😍 ***Phổ biến nhất:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [Franz](https://meetfranz.com/) | Khá lâu đời, tích hợp nhiều nền tảng cho văn phòng | ❌ | ❌ |
| [Ferdium](https://ferdium.org/) | UI/UX đơn giản, tính năng như Franz | ✔ |❌ |

🤩 ***Lựa chọn thay thế:***

| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [Station](https://getstation.com/) | UI/UX đơn giản, tính năng như Franz | ✔ |❌ |
| [Rambox](https://rambox.app/) | UI/UX đơn giản, tính năng như Franz | ❌ | ❌ |
| [Shift](https://shift.com/features/) | Tính năng như Franz nhưng thêm được extensions | ❌ | ❌ |
...
| Tên | Miêu tả | Mã nguồn mở | Trả phí |
|:---|:---|:---:|:---:|
| [Nomacs](https://nomacs.org/) | Gọn nhẹ, có tính năng chỉnh sửa ảnh đơn giản | ✔ |❌ |
| [IrfanView](https://www.irfanview.com/) | UI/UX đơn giản, đáp ứng nhu cầu cơ bản | ❌ | ❌ |
